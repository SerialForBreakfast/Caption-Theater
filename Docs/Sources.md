...
The default offline demo is the project-owned generated fixture:

```text
CaptionTheater/CaptionTheater/Media/OfflineHLS/CaptionTheaterGeneratedWidescreenFixture/caption-theater-generated-master.m3u8
```

It is generated by `Scripts/generate_widescreen_fixture.py` and contains 1920x800 video-only HLS media plus timed segmented WebVTT captions. This is the baseline asset for layout, caption timing, and open-source-safe demos. It is not a substitute for testing real-world streams, but it gives the project a deterministic local fixture when public streams or redistribution rights are uncertain.
